  ...
  return (
    <div className="relative w-[180px] h-[249px] card:w-[190px] card:h-[250px] sm:w-[270px] sm:h-[380px] md:w-[300px] md:h-[415px] xl:w-[324px] xl:h-[450px] mb-2  sm:border-spacing-x-20 border-12 sm:border-15 border-primary shadow-md shadow-slate-300">
      <div className="w-full flex flex-col justify-center items-center">
        ...
        <div className="absolute flex flex-col items-center justify-center top-1/2 left-1/2 -translate-x-1/2 -translate-y-14  sm:-translate-y-24 group ease-in-out">
          <div className="flex flex-col justify-center items-center transition-all group-hover:-translate-y-2">
          ...
          <div className="w-[80px] h-[7px] sm:w-[161px] sm:h-[14px] text-[8px] font-bold rounded-md bg-customRed text-customRed transform -translate-y-3 group-hover:h-[15px] sm:group-hover:h-[20px] sm:text-sm text-center  group-hover:text-white">
