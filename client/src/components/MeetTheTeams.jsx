...
const MeetTheTeams = () => {
  return (
    <div className="w-11/12  flex flex-col justify-center items-center">
      <div className="w-4/5 sm:w-11/12 flex flex-row justify-between items-center max-w-screen-lg mx-auto text-darkBlue font-semibold my-5">
      ...
      <div className="w-10/12 max-w-screen-lg sm:w-11/12 xl:w-10/12 text-base lg:text-2xl text-white bg-customRed py-3 sm:py-5 px-2 sm:px-16 rounded ">
        <p>
